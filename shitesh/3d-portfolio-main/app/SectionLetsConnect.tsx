    ...
    const socialMediaLinks = [
        {
            ...
            height: 168,
            tabIndex: 0,
            onClick: () => window.open('www.linkedin.com/in/shitesh-khaw-359161254', '_blank'),
        },
        {
            initial: { y: 50, opacity: 0 },
            animate: inView ? { y: 0, opacity: 1 } : {},
            ...
            height: 168,
            tabIndex: 0,
            onClick: () => window.open('https://instagram.com/shitesh__khaw', '_blank'),
        },
        {
            initial: { y: -50, opacity: 0 },
            animate: inView ? { y: 0, opacity: 1 } : {},
            ...
            height: 168,
            tabIndex: 0,
            onClick: () => window.open('https://github.com/shiteshkhaw', '_blank')
        },
        {
            initial: { y: -50, opacity: 0 },
            animate: inView ? { y: 0, opacity: 1 } : {},
            ...
            height: 168,
            tabIndex: 0,
            onClick: () => window.open('https://dribbble.com/KhawShitesh', '_blank')
        },
        {
            ...
            height: 310,
            tabIndex: 0,
            onClick: () => window.open('mailto:shiteshkhaw@gmail.com', "_self")
        }
