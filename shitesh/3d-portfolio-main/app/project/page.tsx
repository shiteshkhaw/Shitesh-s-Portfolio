...
const initialProjects = [
    {
        ...
        title: 'Basic Website Using TailWind CSS',
        image: assets.home.myLatestProject.projects.portfolioWebsite,
        repositoryUrl: "https://github.com/shiteshkhaw",
        demoUrl: "https://shiteshkhaw.000webhostapp.com/",
        summary: 'First Ever Website Created using TailWind CSS.',
        techStacks: [
            {
                name: 'Next JS',
    ...
    },
    {
        ...
        image: assets.home.myLatestProject.projects.portfolioWebsite,
        repositoryUrl: "https://github.com/shiteshkhaw",
        demoUrl: "https://shiteshkhaw1602.000webhostapp.com/",
        summary: 'An E-Commerce Website Created Using HTML ,CSS & JAVASCRIPT',
        techStacks: [
            {
                name: 'Next JS',
                imageUrl: 'https://static-00.iconduck.com/assets.00/nextjs-icon-512x512-11yvtwzn.png',
    ...
    return (
        <section ref={ref} className='safe-x-padding mt-[38px] overflow-y-hidden lg:min-h-[1000px]'>
            <div className='text-center'>
                <motion.h2 initial={{ opacity: 0 }} animate={inView ? { opacity: 1 } : {}} transition={{ duration: 0.2 }} className='mb-6 text-5xl font-extrabold lg:text-6xl font-montserrat gradient-text'>Explore Shitesh&apos;s Project</motion.h2>
